...
class SnakeGame extends React.Component {
  constructor(props) {  
    ...
    this.state = {
      width: 0,        //play window width size
      height: 0,        //play window height
      blockWidth: 0,    // divide width:n elements say n-30
      blockHeight: 0,    // divide height:m elements say m-20
      gameLoopTimeout: 50,   //snake moving speed
      timeoutId: 0,       
      startSnakeSize: 0,
      snake: [],        //Xposition and Yposition of snake length
      apple: {},
      direction: 'right',
      directionChanged: false,
      isGameOver: false,
      snakeColor: this.props.snakeColor || getRandomColor(),
      appleColor: this.props.appleColor || getRandomColor(),
      score: 0,
  ...
  initGame() {
    ...
    let percentageWidth = this.props.percentageWidth || 70
    let width =
  ...
  tryToEatApple() {
    ...
    if (snake[0].Xpos === apple.Xpos && snake[0].Ypos === apple.Ypos) {
      let {width, height, blockWidth, blockHeight, 
        highScore,newHighScore, gameLoopTimeout} = this.state
  ...
  moveHeadLeft() {
    let {width, blockWidth, snake} = this.state
    snake[0].Xpos =
  ...
  moveHeadUp() {
    let {height, blockHeight, snake} = this.state
    snake[0].Ypos =
